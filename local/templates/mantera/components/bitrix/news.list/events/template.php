...
<?
    ...
    // $APPLICATION->addHeadScript(SITE_TEMPLATE_PATH . '/assets/js/vendor/modalSignUpEvent.js');
?>
<div class="section-new schedule">
    <div class="container">
        <div class="section-title-right">
            <span class="section-title-right__span">
			<?=Loc::getMessage('SCHEDULE_OF_EVENTS')?>
                <hr class="section-title-right__hr section-title-right__hr--left" />
            </span>
        </div>
        <div class="schedule__inner">
            <div class="schedule-datepicker">
                <input 
                    type="text" 
                    class="datepicker-here schedule-datepicker__input schedule-datepicker__input--date date w-100"  
                    data-range="true"
            ...
            <button class="btn btn--yellow schedule-item__btn btn--search mr-auto" type="button" id="searchEventButton">Найти</button>
        </div>
        ...
        <div class="show-btn">
            <button type="button" class="btn-underline show-more-btn show-more-btn--flex" data-type="true" onclick="ShowMore();"><?=Loc::getMessage('SHOW_MORE')?></button>
        </div>
